...
//just added
	public function dbGetBrand(){
		return array("-","Thurible","Chair","Chalice","Cube","Animated Thurible");
	}
	...
	public function dbCreateTable(){
		try{
			...
			return "Model_3D table is successfully created inside test4a.db file";
		}
		...
		try{
			$this->dbhandle->exec(
				"INSERT INTO Model_3D (Id, brand, x3dModelTitle, x3dCreationMethod, modelTitle, modelSubtitle, modelDescription) 
					VALUES (1, 'Thurible', 'X3D Thurible Model', '3DS MAX 2017', 'Thurible','Used for Special Masses','string_5'); " .
				"INSERT INTO Model_3D (Id, brand, x3dModelTitle, x3dCreationMethod, modelTitle, modelSubtitle, modelDescription) 
				...
				return "X3D model data inserted successfully inside test4a.db";
		}
		catch(PD0EXception $e) {
			print new Exception($e->getMessage());
		}
